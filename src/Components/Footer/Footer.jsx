...
export default function Footer() {
  return (
    <>
          ...
          <div className="flex flex-wrap">
            ...
            <div className="md:w-1/3 w-1/1">
              <div className="text-center p-5">
                ...
                <div className="flex gap-3 justify-center items-center mt-4">
                  <div className="p-1.5 rounded-full border border-white">
                    <svg
            ...
            <div className="md:w-1/3 w-1/1">
              <div className="text-center p-5">
                ...
                <p>
                  Freelance is a free to use, licensed TailwindCss theme created
                  by Route{" "}
                </p>
              </div>
            </div>
      ...
      <div className="bg-[#212529] text-white text-center capitalize py-4">
